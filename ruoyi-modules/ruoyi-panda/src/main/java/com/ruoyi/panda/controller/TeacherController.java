...
import com.ruoyi.panda.domain.Teacher;
import com.ruoyi.panda.service.ITeacherService;
...
public class TeacherController extends BaseController
{
     ...
     * 查询教师列表
     */
    @RequiresPermissions("panda:teacher:list")
    @GetMapping("/list")
     ...
     * 导出教师列表
     */
    @RequiresPermissions("panda:teacher:export")
     ...
     * 获取教师详细信息
     */
    @RequiresPermissions("panda:teacher:query")
     ...
     * 新增教师
     */
    @RequiresPermissions("panda:teacher:add")
     ...
     * 修改教师
     */
    @RequiresPermissions("panda:teacher:edit")
     ...
     * 删除教师
     */
    @RequiresPermissions("panda:teacher:remove")
